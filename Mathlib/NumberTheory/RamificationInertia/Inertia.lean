...
lemma absNorm_eq_pow_inertiaDeg_of_liesOver {S : Type*} [CommRing S] [IsDedekindDomain S]
    [Module.IsFree ℤ S] [IsDedekindDomain R] [Module.IsFree ℤ R] [Algebra S R] [Module.Finite S R]
...
lemma absNorm_eq_pow_inertiaDeg [IsDedekindDomain R] [Module.IsFree ℤ R] [Module.Finite ℤ R] {p : ℤ}
...
lemma absNorm_eq_pow_inertiaDeg' [IsDedekindDomain R] [Module.IsFree ℤ R] [Module.Finite ℤ R] {p : ℕ}
